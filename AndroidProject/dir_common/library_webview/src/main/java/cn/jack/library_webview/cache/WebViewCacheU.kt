package cn.jack.library_webview.cache
...
class WebViewCacheU {
    ...
    companion object {
        ...
        private val webViewCacheStack = Stack<cn.jack.library_webview.base.webview.BaseWebView>()
        ...
        fun acquireWebViewInternal(context: Context): cn.jack.library_webview.base.webview.BaseWebView {
        ...
        private fun createWebView(context: Context): cn.jack.library_webview.base.webview.BaseWebView {
            return cn.jack.library_webview.base.webview.BaseWebView(context)
        }
    }
}