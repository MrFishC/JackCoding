...
class HomeActivity :
    ...
    private val tabText = arrayOf("首页", "项目", "体系", "更多","收藏")

    //未选中icon
    private val normalIcon =
        intArrayOf(R.mipmap.index, R.mipmap.find, R.mipmap.message, R.mipmap.me,R.mipmap.uncollection)

    //选中时icon
    private val selectIcon =
        intArrayOf(R.mipmap.index1, R.mipmap.find1, R.mipmap.message1, R.mipmap.me1, R.mipmap.collection)
    ...
    override fun prepareData() {
        ...
        mFragments.add(
            ARouter.getInstance().build(RouterPathFragment.HomeFive.PAGER_HOME_FIVE)
                .navigation() as Fragment
        )
