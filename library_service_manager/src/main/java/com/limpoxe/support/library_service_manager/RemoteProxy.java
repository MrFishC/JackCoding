package com.limpoxe.support.library_service_manager;
...
import com.limpoxe.support.library_service_manager.compat.BundleCompat;
import com.limpoxe.support.library_service_manager.compat.ContentProviderCompat;
import com.limpoxe.support.library_service_manager.util.ParamUtil;
                    ...
                    new InvocationHandler() {
                        ...
                        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                            ...
                            if (!method.getReturnType().isPrimitive()) {
                                ...
                                throw new IllegalStateException("Service not active! Remote com.jack.library_webview.process may died");
                            }
                        }
