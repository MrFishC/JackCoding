...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<ApiResponse>[] is M) {
      return data.map<ApiResponse>((Map<String, dynamic> e) =>
          ApiResponse.fromJson(e)).toList() as M;
    }
    // if (<ApiResponseData>[] is M) {
    //   return data.map<ApiResponseData>((Map<String, dynamic> e) =>
    //       ApiResponseData.fromJson(e)).toList() as M;
    // }
